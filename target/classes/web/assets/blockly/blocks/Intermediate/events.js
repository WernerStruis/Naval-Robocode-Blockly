...
Blockly.Blocks['ohitbybullet'] = {
    init: function () {
        this.jsonInit({
            "type": "ohitbybullet",
            "colour": Blockly.Msg.EVENT_HUE,
            "tooltip": Blockly.Msg.OHITBYBULLET_TOOLTIP,

            "message0": Blockly.Msg.OHITBYBULLET_TITLE,
            "message1": Blockly.Msg.MAIN_ACTION,
            "args1": [{
                "type": "input_statement",
                "name": "DO"
...
Blockly.Blocks['ohitbymissile'] = {
    init: function () {
        this.jsonInit({
            "type": "ohitbymissile",
            "colour": Blockly.Msg.EVENT_HUE,
            "tooltip": Blockly.Msg.OHITBYMISSILE_TOOLTIP,

            "message0": Blockly.Msg.OHITBYMISSILE_TITLE,
            "message1": Blockly.Msg.MAIN_ACTION,
            "args1": [{
                "type": "input_statement",
                "name": "DO"
...
Blockly.Blocks['oscannedmissile'] = {
    init: function () {
        this.jsonInit({
            "type": "oscannedmissile",
            "colour": Blockly.Msg.EVENT_HUE,
            "tooltip": Blockly.Msg.OSCANNEDMISSILE_TOOLTIP,

            "message0": Blockly.Msg.OSCANNEDMISSILE_TITLE,
            "message1": Blockly.Msg.MAIN_ACTION,
            "args1": [{
                "type": "input_statement",
                "name": "DO"
