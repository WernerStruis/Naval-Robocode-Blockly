...
Blockly.Blocks['atblindspot'] = {
    init: function () {
        this.jsonInit({
            "type": "atblindspot",
            "message0": Blockly.Msg.ATBLINDSPOT_TITLE,
            "args0": [{
                "type": "input_value",
                "name": "SLOT",
                "check": "slot"
            ...
            "inputsInline": true,
            "colour": Blockly.Msg.SLOTACTION_HUE,
            "tooltip": Blockly.Msg.ATBLINDSPOT_TOOLTIP,
            "output": "Boolean"
        });
        this.setOnChange(Blockly.Constants.Validators.ONLY_INLINE_EXTENSION)
    }
};
Blockly.Blocks['atgunheat'] = {
    init: function () {
        this.jsonInit({
            "type": "atgunheat",
            "message0": Blockly.Msg.ATGUNHEAT_TITLE,
            "args0": [{
                "type": "input_value",
                "name": "SLOT",
                "check": "slot"
            ...
            "inputsInline": true,
            "colour": Blockly.Msg.SLOTACTION_HUE,
            "tooltip": Blockly.Msg.ATGUNHEAT_TOOLTIP,
            "output": "Number"
        });
        this.setOnChange(Blockly.Constants.Validators.ONLY_INLINE_EXTENSION)
    }
};
Blockly.Blocks['atheading'] = {
    init: function () {
        this.jsonInit({
            "type": "atheading",
            "message0": Blockly.Msg.ATHEADING_TITLE,
            "args0": [{
                "type": "input_value",
                "name": "SLOT",
                "check": "slot"
            ...
            "inputsInline": true,
            "colour": Blockly.Msg.SLOTACTION_HUE,
            "tooltip": Blockly.Msg.ATHEADING_TOOLTIP,
            "output": "Number"
        });
        this.setOnChange(Blockly.Constants.Validators.ONLY_INLINE_EXTENSION)
    }
};
Blockly.Blocks['atturnremaining'] = {
    init: function () {
        this.jsonInit({
            "type": "atturnremaining",
            "message0": Blockly.Msg.ATTURNREMAINING_TITLE,
            "args0": [{
                "type": "input_value",
                "name": "SLOT",
                "check": "slot"
            ...
            "inputsInline": true,
            "colour": Blockly.Msg.SLOTACTION_HUE,
            "tooltip": Blockly.Msg.ATTURNREMAINING_TOOLTIP,
            "output": "Number"
        });
        this.setOnChange(Blockly.Constants.Validators.ONLY_INLINE_EXTENSION)
    }
